...
//  private OnCorpusSelectedListener mListener; 
  ...
  private static final int EMOJI_PER_PAGE = 24;
  
  //private Button init, people, animal, random, place, others;
  private Button init; 
  private ImageView people, animal, random, place, others;
  final static int N_GROUPS = 5;
  private ImageView [] groups = new ImageView[N_GROUPS];
  public Integer[] peopleList, animalList, randomList, placeList, othersList;
  public int prevSelectedGroupIdx = 0; 
  ...
  public void refleshGroups(boolean showGroups){
	  if(showGroups){
		  for(int i=0;i<N_GROUPS;i++){
			  groups[i].setVisibility(View.VISIBLE);
			  groups[i].setColorFilter(Color.rgb(255, 255, 255), android.graphics.PorterDuff.Mode.MULTIPLY);
			  prevSelectedGroupIdx = 0;
		  }
  ...
  class MyClick implements OnClickListener{
    ...
    private int pressedGroupIdx;
    public MyClick(Integer[] eidList, int pressedGroupIdxIn) {
      this.eidList = eidList;
      pressedGroupIdx = pressedGroupIdxIn;
    }

    @Override
    public void onClick(View v) {
      if (eidList != null) {
    	groups[prevSelectedGroupIdx].setColorFilter(Color.rgb(255, 255, 255), android.graphics.PorterDuff.Mode.MULTIPLY);
    	groups[pressedGroupIdx].setColorFilter(Color.rgb(123, 123, 123), android.graphics.PorterDuff.Mode.MULTIPLY);
    	prevSelectedGroupIdx = pressedGroupIdx;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mBtnSkipQuestion = (Button) findViewById(R.id.buttonSkip);
    mBtnSkipQuestion.setOnClickListener(new View.OnClickListener() {
		@Override
		public void onClick(View v) {
			mSurveyController.skipThisQuestion();
		}
	});
...
//        mSurveyController.showNextQuestion();
    ...
    //people.setBackground(getResources().getDrawable(R.drawable.g5));
    ...
    //animal.setImageDrawable(getResources().getDrawable(R.drawable.g5));
    //animal.setColorFilter(Color.rgb(123, 123, 123), android.graphics.PorterDuff.Mode.MULTIPLY);
    //animal.setColorFilter(Color.rgb(255, 255, 255), android.graphics.PorterDuff.Mode.MULTIPLY);
    ...
    this.people.setOnClickListener(new MyClick(peopleList,0));
    ...
    this.animal.setOnClickListener(new MyClick(animalList,1));
    ...
    this.random.setOnClickListener(new MyClick(randomList,2));
    ...
    this.place.setOnClickListener(new MyClick(placeList,3));
    ...
    this.others.setOnClickListener(new MyClick(othersList,4));
    ...
    for(int gIdx = 0; gIdx < 5; gIdx ++){
    	groups[gIdx].getLayoutParams().width=200; 
    }
